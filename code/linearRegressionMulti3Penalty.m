...
% theta = ones(4,1)*1.5; % [dt1 dt2 cf1 cf2]

fprintf('Running gradient descent... \n')
[theta_history, J_history] = gradientDescentMulti3(X, y, theta, alpha, num_iters);
...
for i = 1:length(theta0_vals)
    for j = 1:length(theta1_vals)
	  theta = [theta0_vals(i); theta1_vals(i); theta2_vals(j); theta3_vals(j)];
	  J_vals(i,j) = computeCostMultiPenalty(X, y, theta);
    end
end
